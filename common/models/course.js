...
module.exports = function(Course) {
  ...
  Course.afterRemote('prototype.__create__students', async (ctx, data) => {
    ...
    const msg = {
      ...
      text:
        'Olá, chegou a hora de começar as atividades. Como dito, fazemos tudo' +
        ' isso pela nossa plataforma https://app.projetomarvin.com.\n\n' +
        'O primeiro acesso será com seu e-mail, e a senha padrão é ' +
        'projetomarvin. Para mudar sua senha, acesse o link abaixo:\n\n' +
  ...
  Course.listCorrectors = async id => {
    ...
    res.students.forEach((s, i) => {
      if (s.corrections[0]) {
        ...
        res.students[i].corrigidoPor =
          res.students[stuCorrIdx].username || res.students[stuCorrIdx].email;
      }
    });
    return res;
  };
